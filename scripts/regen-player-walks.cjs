...
// Base description matching the dark suit in idle/jump/fall frames
...
const WALK_FRAMES = [
  {
    name: 'player_walk1',
    desc: `${BASE} Walking pose: left leg forward, right leg back, left arm back, right arm forward. Facing right.`,
  },
  {
    name: 'player_walk2',
    desc: `${BASE} Walking pose: legs together mid-stride, arms at sides. Facing right.`,
  },
  {
    name: 'player_walk3',
    desc: `${BASE} Walking pose: right leg forward, left leg back, right arm back, left arm forward. Facing right.`,
  },
  {
    name: 'player_walk4',
    desc: `${BASE} Walking pose: legs together, arms slightly out. Facing right.`,
  },
]

async function main() {
  console.log('Regenerating player walk frames (4) to match dark suit...')
